...
export function Nav({ showExpenses = true, showSettings = false }: { showExpenses?: boolean; showSettings?: boolean }) {
  const pathname = usePathname();
  const items = ITEMS.filter(
    (i) => (showExpenses || i.href !== "/expenses") && (showSettings || !i.adminOnly)
  );
  return (
